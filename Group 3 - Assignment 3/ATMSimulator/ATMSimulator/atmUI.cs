    ...
    public partial class atmUI : Form
    {
            ...
            if (pinBeingEntered == true) //if the player is required to enter the pin then 
            {
                ...
                if (temp.Length == 4) //when the length of the input variable is four then 
                {
                    ...
                    pinLabel.Text = "****";
                        ...
                        //refreshes the form
                        this.Refresh(); 
                        Thread.Sleep(500);  //sleep the thread so 4 stars appear
                        ...
                        {
                             //increments number of attempts made to enter pin
       ...
       */
        ...
        public Boolean removeBalance(int money)
        {
            ...
            {
                Console.WriteLine("Time: " + DateTime.Now + " - ATM " + atmID + ":" + "£" + money +" could not be removed due to insufficient funds in account."); //update the bank log
        ...
        */
        ...
        private void option1_Click(object sender, EventArgs e)
        {
            ...
            else if (removeMoneyFromAccount == true) //if the screen asking the user to remove money from their account is displayed then 
            {
                ...
                if (removeBalance(5) == true) //if the balance can be removed then
                {
                    lstMenu.Items.Clear();
                ...
                else //if the balance can not be removed then
                {
                    lstMenu.Items.Clear();
                    enterPressed = true;
        ...
        private void option2_Click(object sender, EventArgs e)
        {
            ...
            {
                if (removeBalance(20) == true) //if the balance can be removed then
                {
                    lstMenu.Items.Clear();
        ...
        private void option3_Click(object sender, EventArgs e)
        {
            ...
            {
                removeMoneyFromAccount = false; //set the boolean value to false 
                if (removeBalance(50) == true) //if the balance can be removed then
                {
                    lstMenu.Items.Clear();
        ...
        private void option4_Click(object sender, EventArgs e)
        {
            ...
            {
                removeMoneyFromAccount = false; //set the boolean value to false 
                if (removeBalance(250) == true) //if the balance can be removed then
                {
                    lstMenu.Items.Clear();
        ...
        private void option5_Click(object sender, EventArgs e)
        {
            ...
            {
                removeMoneyFromAccount = false; //set the boolean value to false 
                if (removeBalance(10) == true) //if the balance can be removed then
                {
                    lstMenu.Items.Clear();
        ...
        private void option6_Click(object sender, EventArgs e)
        {
            ...
            {
                removeMoneyFromAccount = false; //set the boolean value to false 
                if (removeBalance(40) == true) //if the balance can be removed then
                {
                    lstMenu.Items.Clear();
        ...
        private void option7_Click(object sender, EventArgs e)
        {
            ...
            {
                removeMoneyFromAccount = false; //set the boolean value to false 
                if (removeBalance(100) == true) //if the balance can be removed then
                {
                    lstMenu.Items.Clear();
        ...
        private void option8_Click(object sender, EventArgs e)
        {
            ...
            {
                removeMoneyFromAccount = false; //set the boolean value to false 
                if (removeBalance(500) == true) //if the balance can be removed then
                {
                    lstMenu.Items.Clear();
        ...
        private void atm_focus(object sender, EventArgs e)
        {
            checkBlocked();
        }

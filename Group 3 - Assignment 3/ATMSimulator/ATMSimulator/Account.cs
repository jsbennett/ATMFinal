...
namespace ATMSimulator
{
    ...
    public class Account
    {
        ...
        public void incrementAttempts(int atmID)
        {
            ...
            //check to see if card should be blocked and blocks it if it should be
            ...
            else if(attempts == 2) // else display number of attempts left
            {
            ...
            else if (attempts == 1) // else display number of attempts left
            {
